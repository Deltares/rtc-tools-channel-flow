...
model DiffusiveWave
  ...
  extends Internal.PartialBranchDiffusiveWave(nominal_depth = fill(uniform_nominal_depth, n_level_nodes + 1), nominal_width = fill(width, n_level_nodes + 1), H(each min=H_b));
  // Nominal depth
