...
model HomotopicFixedWeir_flat "Homotopic Two-way Fixed Weir For Both Free and Submerged Flow Regimes"
...
equation
  ...
  nonlinear_Q_weir = theta * ((width * (sqrt((-1 * (sqrt(((-(HQDown.H - h)) - (-(HQUp.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQDown.H - h)) + (-(HQUp.H - h))) / 2)) ^ 2 + Modelica.Constants.eps) / 2 + (-1 * (sqrt(((-(HQDown.H - h)) - (-(HQUp.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQDown.H - h)) + (-(HQUp.H - h))) / 2)) / 2) * sqrt(2.0 * Modelica.Constants.g_n * submerged_flow_factor *  sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps)) * (HQUp.H - HQDown.H) / sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps)) * (1 - ((sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps) / 2 + (sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) / 2) / sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps))) + (2.0 / 3.0 * width * (2.0 / 3.0 * Modelica.Constants.g_n) ^ 0.5 * (sqrt((sqrt(((HQDown.H - h) - (HQUp.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQDown.H - h) + (HQUp.H - h)) / 2) ^ 2 + Modelica.Constants.eps) / 2 + ((sqrt(((HQDown.H - h) - (HQUp.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQDown.H - h) + (HQUp.H - h)) / 2)) / 2) ^ exponent * (HQUp.H - HQDown.H) / sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps)) * ((sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps) / 2 + (sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) / 2) / sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps)));
  ...
  //nonlinear_Q_submerged_weir = (width * (sqrt((-1 * (sqrt(((-(HQDown.H - h)) - (-(HQUp.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQDown.H - h)) + (-(HQUp.H - h))) / 2)) ^ 2 + Modelica.Constants.eps) / 2 + (-1 * (sqrt(((-(HQDown.H - h)) - (-(HQUp.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQDown.H - h)) + (-(HQUp.H - h))) / 2)) / 2) * sqrt(2.0 * Modelica.Constants.g_n * submerged_flow_factor *  sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps)) * (HQUp.H - HQDown.H) / sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps));
  ...
  //nonlinear_Q_free_weir = (2.0 / 3.0 * width * (2.0 / 3.0 * Modelica.Constants.g_n) ^ 0.5 * (sqrt((sqrt(((HQDown.H - h) - (HQUp.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQDown.H - h) + (HQUp.H - h)) / 2) ^ 2 + Modelica.Constants.eps) / 2 + ((sqrt(((HQDown.H - h) - (HQUp.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQDown.H - h) + (HQUp.H - h)) / 2)) / 2) ^ exponent * (HQUp.H - HQDown.H) / sqrt((HQUp.H - HQDown.H) ^ 2 + Modelica.Constants.eps));
  ...
  //one_if_free_flow = ((sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps) / 2 + (sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) / 2) / sqrt((sqrt(((HQUp.H - h) - (HQDown.H - h)) ^ 2 + Modelica.Constants.eps) / 2 + ((HQUp.H - h) + (HQDown.H - h)) / 2 + submerged_flow_ratio * (sqrt(((-(HQUp.H - h)) - (-(HQDown.H - h))) ^ 2 + Modelica.Constants.eps) / 2 + ((-(HQUp.H - h)) + (-(HQDown.H - h))) / 2)) ^ 2 + Modelica.Constants.eps));
