...
model HomotopicFixedSubmergedWeir "Homotopic Two-way Fixed Weir In the Submerged Flow Regime"
  ...
  parameter Integer nonlinear_hardness_factor = 20;
...
equation
  ...
  //Q = width * (HDown- h) * Sqrt[ 2.0 * g * submergedFlowFactor * (HUp- HDown) ]
...
end HomotopicFixedSubmergedWeir;