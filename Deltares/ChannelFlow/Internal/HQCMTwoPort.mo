...
//  Deltares.ChannelFlow.Interfaces.HQCMPort HQUp = HQCMUp; // For backwards compatibility
//  Deltares.ChannelFlow.Interfaces.HQCMPort HQDown = HQCMDown; // For backwards compatibility
